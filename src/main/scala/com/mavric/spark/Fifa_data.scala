...
object Fifa_data {
  def main(args: Array[String]): Unit = {
    ...
    val Strong_442team = Fifa_Clean_Data.filter($"Position".isin("GK", "RB", "CB", "RCB", "CB", "LCB", "LB", "RM", "RWM", "LCM", "CM", "RCM", "CM", "LM", "LWM", "RF", "CF", "LF", "ST"))
    ...
    Expensive_squadValue.show(false)
   ...
   // Postgre_file.write
    ...
    //option('driver', 'org.postgresql.Driver').jdbc(url_connect, table, mode, properties)
  }
